...
P6_hent_vl_fra_tlf(ByRef tlf:="")
{
    ...
    række := DataBasefind( "%A_linefile%\..\trafikstyring\db\VL_tlf.txt", tlf)
    ; MsgBox,,række, % række.1
    celle := databaseget("%A_linefile%\..\trafikstyring\db\VL_tlf.txt", række.1, 2)
...
Flexfinder_til_p6()
{
    ...
    PixelSearch, Px, Py, 13, 182, 1203, 230, 0x5B6CF2, 0, Fast ; Virker ikke i fuld skærm (F11). Virker med alt+enter.
    click %Px%, %Py%
    click %Px%, %Py%
