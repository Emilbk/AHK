...
Menu, SvigtFilmenu, add, Vogngruppe`tCtrl+t, svigtVogngruppe  
...
Gui svigt: Font
Gui svigt: Font, s9, Segoe UI
Gui svigt: Add, Radio, vlukket1 x160 y25 , &Åbningstid udskudt
Gui svigt: Add, Edit, disabled vtid1 x180 y40 w79 h21, Vl start kl.
Gui svigt: Add, Radio, vlukket x160 y65 , Lukket &midt på VL
Gui svigt: Add, Edit, disabled vtid x180 y80 w79 h21, Hjemzone kl.
Gui svigt: Add, Radio, vlukket2 x160 y105 , VL S&lettet
...
Gui svigt: Add, Radio, x160 y147 h23, Kontaktet
Gui svigt: Add, Radio, x240 y147 h23, Ingen kontakt
Gui svigt: Add, Edit, disabled vtidvm x340 y147 w50, ca. kl.
Gui svigt: Add, Text, x16 y157 h23 +0x200, &Beskrivelse
Gui svigt: Font
Gui svigt: Font, s9, Segoe UI
Gui svigt: Add, Edit, vbeskrivelse x16 y180 w410 h106
Gui svigt: Add, CheckBox, vgemt_ja x5 y354, Brug &forrige skærmklip
; Gui svigt: Add, CheckBox, vgemt_j x5 y374, Tilføj & skærmklip
Gui svigt: Add, Button, x160 y359 w60 h23 vvis +default, &Vis
Gui svigt: Add, Button, x240 y359 w60 h23 vsend , &Send
...
+^z::
{
   ...
   Gui svigt: Show, w448 h400, Svigt
  return
