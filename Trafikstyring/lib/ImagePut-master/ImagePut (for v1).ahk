...
class ImagePut {
   ...
   StreamToExplorer(pStream, default := "") {
   ...
   ParseWebp(pStream, ByRef pDelays, ByRef pCount) {
      ...
      DllCall(NumGet(NumGet(pStream+0)+A_PtrSize* 5), "ptr", pStream, "uint64", 12, "uint", 0, "uint64*", current)
